...
export default class Wordie {
    ...
    makeGuess(guess) {
        if (this.guessesLeft === 0)
            return;
        if (this.words.find((word) => word.toUpperCase() === guess.toUpperCase()) === undefined)
            return;
    ...
    getGuesses() {
        ...
        for (let i = 0; i < this.guesses.length; i++) {
            guessDiv.appendChild(this.guesses[i].writeGuess());
        }
        return guessDiv.innerHTML;
    }
}
//# sourceMappingURL=Wordie.js.map